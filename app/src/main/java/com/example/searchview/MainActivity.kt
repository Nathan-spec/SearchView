...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // initializing variables of list view their ids.
        ...
        programmingLanguagesList.add("C++")
        programmingLanguagesList.add("HTML")
        programmingLanguagesList.add("CSS")
        programmingLanguagesList.add("Unity")
        programmingLanguagesList.add("PHP")
        programmingLanguagesList.add("Pearl")
        programmingLanguagesList.add("Swift")
        programmingLanguagesList.add("SQL")
        programmingLanguagesList.add("Powershell")
        programmingLanguagesList.add("Assembly Language")
        programmingLanguagesList.add("Groovy")
